...
export const poolTypeEnum = pgEnum("pool_type", ["season", "weekly", "mid_season", "pickem", "group_stage_predictor", "pickem_season", "nfl_division_predictor", "dirty_dozen", "crazy_8s", "nfl_confidence", "nfl_confidence_weekly", "wc_bracket", "mlb_bracket", "nba_ats"]);
...
export const poolsTable = pgTable("pools", {
  ...
  commissionerCut: integer("commissioner_cut").default(0),
  showCommissionerCut: boolean("show_commissioner_cut").notNull().default(false),
