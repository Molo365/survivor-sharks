...
--> statement-breakpoint
ALTER TABLE "pick_reminders" ADD CONSTRAINT "pick_reminders_pool_id_pools_id_fk" FOREIGN KEY ("pool_id") REFERENCES "public"."pools"("id") ON DELETE cascade ON UPDATE no action;ALTER TABLE "users" ADD COLUMN "reminders_enabled" boolean DEFAULT true NOT NULL;
--> statement-breakpoint
CREATE TYPE "public"."pick_reminder_stage" AS ENUM('24h', 'final');
--> statement-breakpoint
CREATE TYPE "public"."pick_reminder_status" AS ENUM('sent', 'failed');
