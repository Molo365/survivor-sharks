...
export const ListPoolsResponseItem = zod.object({
  ...
  "name": zod.string(),
  "sport": zod.string(),
  "poolType": zod.enum(['season', 'weekly', 'mid_season', 'pickem', 'group_stage_predictor', 'pickem_season', 'nfl_division_predictor', 'dirty_dozen', 'crazy_8s', 'nfl_confidence']),
...
export const CreatePoolBody = zod.object({
  ...
  "poolType": zod.enum(['season', 'weekly', 'mid_season', 'pickem', 'group_stage_predictor', 'pickem_season', 'nfl_division_predictor', 'dirty_dozen', 'crazy_8s', 'nfl_confidence']).default(createPoolBodyPoolTypeDefault),
...
export const UpdatePoolBody = zod.object({
  ...
  "poolType": zod.enum(['season', 'weekly', 'mid_season', 'pickem', 'group_stage_predictor', 'pickem_season', 'nfl_division_predictor', 'dirty_dozen', 'crazy_8s', 'nfl_confidence']).optional(),
...
export const getNflPickEmSeasonGamesQueryWeekMax = 18;



export const GetNflPickEmSeasonGamesQueryParams = zod.object({
  "week": zod.coerce.number().min(1).max(getNflPickEmSeasonGamesQueryWeekMax).optional().describe('NFL week number (1-18). Defaults to pool\'s currentWeek.')
})
...
export const SubmitNflPickEmSeasonPicksBody = zod.object({
  "week": zod.number().min(1).max(submitNflPickEmSeasonPicksBodyWeekMax),
  "picks": zod.array(zod.object({
  "gameId": zod.string(),
  "pickedTeamId": zod.string(),
  "pickedTeamName": zod.string()
...
export const ProcessNflPickEmSeasonResultsBody = zod.object({
  "week": zod.number().optional().describe('NFL week to grade (defaults to pool\'s currentWeek)')
})
