...
export const ListPoolsResponseItem = zod.object({
  ...
  "name": zod.string(),
  "sport": zod.string(),
  "poolType": zod.enum(['season', 'weekly', 'mid_season', 'pickem', 'group_stage_predictor', 'pickem_season', 'nfl_division_predictor', 'dirty_dozen', 'crazy_8s']),
...
export const CreatePoolBody = zod.object({
  ...
  "poolType": zod.enum(['season', 'weekly', 'mid_season', 'pickem', 'group_stage_predictor', 'pickem_season', 'nfl_division_predictor', 'dirty_dozen', 'crazy_8s']).default(createPoolBodyPoolTypeDefault),
...
export const UpdatePoolBody = zod.object({
  ...
  "poolType": zod.enum(['season', 'weekly', 'mid_season', 'pickem', 'group_stage_predictor', 'pickem_season', 'nfl_division_predictor', 'dirty_dozen', 'crazy_8s']).optional(),
