...
export const getGetNflPickEmSeasonGamesQueryOptions = <TData = Awaited<ReturnType<typeof getNflPickEmSeasonGames>>, TError = ErrorType<ErrorResponse>>(poolId: number,
...
export type GetNflPickEmSeasonGamesQueryError = ErrorType<ErrorResponse>
...
export function useGetNflPickEmSeasonGames<TData = Awaited<ReturnType<typeof getNflPickEmSeasonGames>>, TError = ErrorType<ErrorResponse>>(
 poolId: number,
    params?: GetNflPickEmSeasonGamesParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNflPickEmSeasonGames>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
/**
 * @summary Submit picks for an NFL week (locks per-game at kickoff)
 */
export const submitNflPickEmSeasonPicks = async (poolId: number,
    nflPickEmSeasonPickInput: NflPickEmSeasonPickInput, options?: RequestInit): Promise<PickEmPicksResult> => {

  return customFetch<PickEmPicksResult>(getSubmitNflPickEmSeasonPicksUrl(poolId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getSubmitNflPickEmSeasonPicksMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitNflPickEmSeasonPicks>>, TError,{poolId: number;data: BodyType<NflPickEmSeasonPickInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof submitNflPickEmSeasonPicks>>, TError,{poolId: number;data: BodyType<NflPickEmSeasonPickInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof submitNflPickEmSeasonPicks>>, {poolId: number;data: BodyType<NflPickEmSeasonPickInput>}> = (props) => {
          const {poolId,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SubmitNflPickEmSeasonPicksMutationBody = BodyType<NflPickEmSeasonPickInput>
    export type SubmitNflPickEmSeasonPicksMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Submit picks for an NFL week (locks per-game at kickoff)
 */
export const useSubmitNflPickEmSeasonPicks = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitNflPickEmSeasonPicks>>, TError,{poolId: number;data: BodyType<NflPickEmSeasonPickInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof submitNflPickEmSeasonPicks>>,
        TError,
        {poolId: number;data: BodyType<NflPickEmSeasonPickInput>},
        TContext
      > => {
...
/**
 * @summary Get season-long leaderboard with weekly breakdowns and tiebreaker info
 */
...
/**
 * @summary Grade completed games for a given NFL week (commissioner/admin only)
 */
...
export const getProcessNflPickEmSeasonResultsMutationOptions = <TError = ErrorType<ErrorResponse>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ProcessNflPickEmSeasonResultsMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Grade completed games for a given NFL week (commissioner/admin only)
 */
export const useProcessNflPickEmSeasonResults = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof processNflPickEmSeasonResults>>, TError,{poolId: number;data?: BodyType<ProcessNflPickEmSeasonResultsBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
