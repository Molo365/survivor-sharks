...
import nhlNdpRouter from "./nhl-ndp";
...
import mlbBracketRouter from "./mlb-bracket";
...
router.use("/pools/:poolId/nhl-ndp", nhlNdpRouter);
...
router.use("/pools/:poolId/mlb-bracket", mlbBracketRouter);
