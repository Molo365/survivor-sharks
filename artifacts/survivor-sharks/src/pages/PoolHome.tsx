          ...
          <div className="space-y-2 md:space-y-8">
            ...
            {isMlbBracket ? (
                ...
                <div className="relative">
                  <div>
                    <TabsList className="bg-transparent border-0 flex flex-wrap h-auto p-1.5 gap-1 shadow-sm w-full">
                      <TabsTrigger value="picks" className="shrink-0 rounded-lg border border-primary/20 bg-primary/5 text-primary/70 hover:border-primary/40 hover:bg-primary/10 hover:text-primary font-bebas text-sm md:text-xl tracking-wider px-2 md:px-5 py-2 md:py-2.5 data-[state=active]:bg-purple-500/10 data-[state=active]:text-purple-400 flex gap-2">
                        <Dice5 className="w-4 h-4 md:w-5 md:h-5" /> {pool.sport === "nhl" ? "Weekend Picks" : "Today's Picks"}
                      </TabsTrigger>
                      <TabsTrigger value="leaderboard" className="shrink-0 rounded-lg border border-accent/20 bg-accent/5 text-accent/70 hover:border-accent/40 hover:bg-accent/10 hover:text-accent font-bebas text-sm md:text-xl tracking-wider px-2 md:px-5 py-2 md:py-2.5 data-[state=active]:bg-accent/10 data-[state=active]:text-accent flex gap-2">
                        <Activity className="w-4 h-4 md:w-5 md:h-5" /> Leaderboard
                      </TabsTrigger>
                      <TabsTrigger value="grid" className="shrink-0 rounded-lg border border-purple-500/20 bg-purple-500/5 text-purple-400/70 hover:border-purple-500/40 hover:bg-purple-500/10 hover:text-purple-400 font-bebas text-sm md:text-xl tracking-wider px-2 md:px-5 py-2 md:py-2.5 flex gap-2">
                        {pool.sport === "nhl" ? "Weekend Grid" : "Daily Grid"}
                      </TabsTrigger>
                      <TabsTrigger value="snapshot" className="shrink-0 rounded-lg border border-cyan-500/20 bg-cyan-500/5 text-cyan-400/70 hover:border-cyan-500/40 hover:bg-cyan-500/10 hover:text-cyan-400 font-bebas text-sm md:text-xl tracking-wider px-2 md:px-5 py-2 md:py-2.5 flex gap-2">
                        <Camera className="w-4 h-4 md:w-5 md:h-5" /> Snapshot
                      </TabsTrigger>
                      {isCommissioner && (
                        <TabsTrigger value="commissioner" className="shrink-0 rounded-lg border border-amber-500/20 bg-amber-500/5 text-amber-400/70 hover:border-amber-500/40 hover:bg-amber-500/10 hover:text-amber-300 font-bebas text-sm md:text-xl tracking-wider px-2 md:px-5 py-2 md:py-2.5 md:ml-auto flex gap-2">
              ...
              <NflConfidenceWeeklyWinnerBanner poolId={pool.id} currentWeek={pool.currentWeek} />
               <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <div className="relative">
                  <div>
                    <TabsList className="bg-transparent border-0 flex flex-wrap h-auto p-1.5 gap-1 shadow-sm w-full">
                      <TabsTrigger value="picks" className="shrink-0 rounded-lg border border-primary/20 bg-primary/5 text-primary/70 hover:border-primary/40 hover:bg-primary/10 hover:text-primary font-bebas text-sm md:text-xl tracking-wider px-2 md:px-5 py-2 md:py-2.5 data-[state=active]:bg-cyan-500/10 data-[state=active]:text-cyan-400 flex gap-2">
             ...
             <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <div>
              <TabsList className="bg-transparent border-0 flex flex-wrap h-auto p-1.5 gap-1 shadow-sm w-full">
                <TabsTrigger value="picks" className="shrink-0 rounded-lg border border-primary/20 bg-primary/5 text-primary/70 hover:border-primary/40 hover:bg-primary/10 hover:text-primary font-bebas text-sm md:text-xl tracking-wider px-2 md:px-5 py-2 md:py-2.5 data-[state=active]:bg-primary/10 data-[state=active]:text-primary flex gap-2">
