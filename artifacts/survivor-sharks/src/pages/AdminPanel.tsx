...
interface PoolRow { id: number; name: string; sport: string; isActive: boolean; memberCount: number; commissionerName: string; currentWeek: number; season: number; createdAt: string }
