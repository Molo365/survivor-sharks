      ...
      <Tabs defaultValue="picks" className="w-full">
        <div className="relative">
          ...
          <TabsList className="bg-transparent border-0 flex flex-wrap h-auto p-1 gap-1 w-full">
            ...
            <TabsTrigger value="leaderboard" className="flex-1 min-w-0 rounded-full truncate border border-accent/20 bg-accent/5 text-accent/70 hover:border-accent/40 hover:bg-accent/10 hover:text-accent font-bebas text-sm md:text-lg tracking-wider px-4 md:px-5 py-2.5 md:py-2.5 gap-2">
              <Trophy className="w-4 h-4" /> Leaderboard
            </TabsTrigger>
            <TabsTrigger value="standings" className="flex-1 min-w-0 rounded-full truncate border border-sky-500/20 bg-sky-500/5 text-sky-400/70 hover:border-sky-500/40 hover:bg-sky-500/10 hover:text-sky-400 font-bebas text-sm md:text-lg tracking-wider px-4 md:px-5 py-2.5 md:py-2.5 gap-2">
              <Globe className="w-4 h-4" /> Live Standings
            </TabsTrigger>
            {isCommissioner && (
              <TabsTrigger value="commissioner" className="flex-1 min-w-0 rounded-full truncate border border-amber-500/20 bg-amber-500/5 text-amber-400/70 hover:border-amber-500/40 hover:bg-amber-500/10 hover:text-amber-300 font-bebas text-sm md:text-lg tracking-wider px-4 md:px-5 py-2.5 md:py-2.5 gap-2 md:ml-auto">
