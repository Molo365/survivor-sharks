      ...
      <Tabs defaultValue="picks" className="w-full">
        <div className="relative">
          ...
          <TabsList className="bg-card border border-border flex flex-wrap h-auto p-1 gap-1 w-full">
            <TabsTrigger value="picks" className="shrink-0 font-bebas text-sm md:text-lg tracking-wider px-2 md:px-5 py-2 md:py-2.5 gap-2">
              <ListOrdered className="w-4 h-4" /> My Picks
            </TabsTrigger>
            <TabsTrigger value="leaderboard" className="shrink-0 font-bebas text-sm md:text-lg tracking-wider px-2 md:px-5 py-2 md:py-2.5 gap-2">
              <Trophy className="w-4 h-4" /> Leaderboard
            </TabsTrigger>
            <TabsTrigger value="standings" className="shrink-0 font-bebas text-sm md:text-lg tracking-wider px-2 md:px-5 py-2 md:py-2.5 gap-2">
              <Globe className="w-4 h-4" /> Live Standings
            </TabsTrigger>
            {isCommissioner && (
              <TabsTrigger value="commissioner" className="shrink-0 font-bebas text-sm md:text-lg tracking-wider px-2 md:px-5 py-2 md:py-2.5 gap-2 text-muted-foreground hover:text-foreground md:ml-auto">
