        ...
        <div className="relative">
          <div>
            <TabsList className="bg-transparent border-0 flex flex-wrap h-auto p-1.5 gap-1 shadow-sm w-full">
              <TabsTrigger
                value="matches"
                className="flex-1 min-w-0 rounded-full truncate border border-primary/20 bg-primary/5 text-primary/70 hover:border-primary/40 hover:bg-primary/10 hover:text-primary font-bebas text-sm md:text-xl tracking-wider px-4 md:px-5 py-2.5 md:py-2.5 data-[state=active]:bg-green-500/10 data-[state=active]:text-green-400 flex gap-2"
              >
              ...
              <TabsTrigger
                value="grid"
                className="flex-1 min-w-0 rounded-full truncate border border-purple-500/20 bg-purple-500/5 text-purple-400/70 hover:border-purple-500/40 hover:bg-purple-500/10 hover:text-purple-400 font-bebas text-sm md:text-xl tracking-wider px-4 md:px-5 py-2.5 md:py-2.5 data-[state=active]:bg-blue-500/10 data-[state=active]:text-blue-400 flex gap-2"
              >
                <LayoutGrid className="w-4 h-4 md:w-5 md:h-5" /> Grid
              </TabsTrigger>
              <TabsTrigger
                value="bracket"
                className="flex-1 min-w-0 rounded-full truncate border border-fuchsia-500/20 bg-fuchsia-500/5 text-fuchsia-400/70 hover:border-fuchsia-500/40 hover:bg-fuchsia-500/10 hover:text-fuchsia-400 font-bebas text-sm md:text-xl tracking-wider px-4 md:px-5 py-2.5 md:py-2.5 data-[state=active]:bg-yellow-500/10 data-[state=active]:text-yellow-400 flex gap-2"
              >
