...
- [Survivor mass-elimination paths](survivor-mass-elimination-paths.md) — manual void handling is not shared with live per-sport auto-closure; trace both paths before changing Survivor rules.
